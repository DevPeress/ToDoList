...
export default function Register() {
    ...
    return (
        <div className="flex absolute w-full min-h-screen overflow-hidden items-center justify-center">
            ...
            <div className="flex flex-col absolute w-[50vw] h-auto top-[10vw] rounded flex-wrap space-y-2">
                {fazer.map((item, index) => (
                    <>
                        <div key={index} className="flex w-full h-[2vw] bg-gray-500 items-center justify-start pl-[1vw] text-white text-[1vw] rounded">
